	...
	<td>
	  <xsl:for-each select="//certificate">
	    <table class="cert" width ="100%">
	      <tr>
		<td class="title"  ><h1 align="center"><xsl:value-of select="//template/name"/></h1></td>
	      </tr>
	      <tr>
		<td>
		  <table  width ="100%">
		...
		<td>
		  <table width =" 100%">
		    ...
		    <xsl:for-each select="//certificate/people/person">
		      <tr  height="24">
			<td class="input" ><xsl:value-of select="householdReference"/></td>
		    ...
		    <tr>
		      ...
		      <td class="input"><xsl:value-of select="inhabitedHouses"/><xsl:value-of select="uninhabitedHouses"/></td>
