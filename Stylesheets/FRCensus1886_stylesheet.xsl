                        ...
                        <table class="cert" width ="100%">
                            ...
                            <tr>
                                <td>
                                    <table border="0"   width =" 100%"  >
                                        <tr>
                                            <td width="20%" text-align="left" class="annee"  >
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table border="0"   width =" 100%">
                                        <tr>
                                            <td class="bst"  rowspan="1">Designation<br/>hameau</td>
                                            ...
                                            <td  class="bst" rowspan="2">Age</td>
                                            <td  class="bst" rowspan="2">Nationa<br/>lite<br/>te</td>
                                            <td  class="bst" rowspan="2">profession</td>
                                            <td  class="bst" rowspan="2">Situation</td>
                                            <td  class="bst" rowspan="2">Observations</td>
                                        </tr>
                                         <tr>
                                            <td  class="bsts" ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="comment" >
                                                ...
                                                <xsl:if test="$hyperlink"> 
                                                        ...
                                                        <a href="{$hyperlink}"  target="_blank" onclick="window.open('{$hyperlink}', 'newwindow', 'width=600, height=500'); return false;"  >View Image</a>
